package com.example.dell.wy_one.model.http;


import android.util.Log;

import com.example.dell.wy_one.model.interfaces.MyService;
...
public class RetrofitUtils {
    ...
    public static MyService getService(){
        return RetrofitUtils.getInstance(HttpConfig.BASE_URL).createService(MyService.class);
    }
